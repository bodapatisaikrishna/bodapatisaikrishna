...
<div align="center">
  <img src="assets/banner_title.png" alt="Sai Krishna" width="100%" />
</div>

<br />

<div align="center">
  <img src="assets/cyber_workstation.png" alt="Cyberpunk AI Research & Systems Lab" width="100%" />
</div>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Status-Open%20to%20Roles-238636?style=for-the-badge" alt="Open to Roles" />
</p>
...
![DBNs](https://img.shields.io/badge/Dynamic_Bayesian_Networks-2D3748?style=flat-square)
![VAEs](https://img.shields.io/badge/Variational_Autoencoders-2D3748?style=flat-square)
![RL](https://img.shields.io/badge/PPO_%2F_Reinforcement_Learning-2D3748?style=flat-square)
...
![SimPy](https://img.shields.io/badge/SimPy-555555?style=for-the-badge)
![Network IDS](https://img.shields.io/badge/Network_IDS-D9381E?style=for-the-badge)
![IEC 60870-5-104](https://img.shields.io/badge/IEC_60870--5--104-1F6FEB?style=for-the-badge)
...
|:---:|---|---|
| [#127627](https://github.com/tensorflow/tensorflow/pull/127627) | <img src="https://github.com/tensorflow.png" width="16" height="16" alt="TensorFlow"/> `tensorflow/tensorflow` | **[Numerical Correctness]** Fixed `tf.linalg.expm` returning a second derivative off by ~3.6e8 under nested forward-mode autodiff, by normalizing the Padé approximant coefficients by `b_0` (per Higham 2005) so they stay in (0, 1]. |
| [#10625](https://github.com/celery/celery/pull/10625) | <img src="https://github.com/celery.png" width="16" height="16" alt="Celery"/> `celery/celery` | **[Correctness Fix]** Fixed `utcoffset()` to return the exact fractional UTC offset instead of a truncated integer, eliminating timestamp drift for fractional-hour timezones (e.g. India, Nepal) in event timestamp correction. |
...
| [#5293](https://github.com/facebook/Ax/pull/5293) | <img src="https://github.com/facebook.png" width="16" height="16" alt="Meta"/> `facebook/Ax` | **[Correctness]** Fixed a discrete-choice ordering bug in Bayesian optimization's local-search acquisition path: `fixed_parameters` with a continuous feature silently desynced candidate columns from parameter bounds, causing BoTorch to raise during generation. |
| [#3732](https://github.com/apache/dubbo-go/pull/3732) | <img src="https://github.com/apache.png" width="16" height="16" alt="Apache"/> `apache/dubbo-go` | **[Concurrency &amp; Data Race]** Closed a high-concurrency race condition on router cache using `atomic.Pointer` under concurrent route generation. |
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&section=footer&height=100&color=0:1f6feb,100:0d1117" width="100%" alt="Terminal Footer" />
</div>
